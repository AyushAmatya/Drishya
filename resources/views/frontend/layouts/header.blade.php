        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 no-pad media_respo">
                <div class="social_media wow bounceInRight"
                    ...
                    <ul>
                        <li class="icon_bg1"><a href="{{$social->facebook}}"><i class="fab fa-facebook-f"></i></a></li>
                        <li class="icon_bg2"><a href="{{$social->twitter}}"><i class="fab fa-twitter"></i></a></li>
                        <li class="icon_bg1"><a href="{{$social->instagram}}"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                        </li>
                        <li class="icon_bg2"><a href="{{$social->youtube}}"><i class="fab fa-youtube"></i></a> </li>
                        <li class="icon_bg1"><a href="#"><i class="fab fa-google-plus-g"></i></a></li>
                    </ul>
                        @endforeach
                </div><!-- social_media -->
            </div><!-- col -->
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="header_logo">
                    <a href="{{route('index')}}"><img src="{{asset('images/softechparklogo_2x.png')}}" alt="#" /></a>
                </div><!-- header_logo -->
            </div><!-- col -->
            ...
            <div class="col-6 col-md-2 border_right">
                <div class="header_opening_closing">
                 <i class="far fa-clock"></i>
                    <p>Opening Time <span>Sun - Fri : 10.00 - 5.00</span></p>
                </div><!-- header_closing -->
            </div><!-- col -->
            <div class="col-md-3">
                    ...
                    <form action="{{route('contacts.store')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="input_form">
                                ...
                                <input type="text" name="phone1" placeholder="Contact Number">
            ...
            <div class="main_nav">
                <nav class="navbar navbar-expand-lg navbar-light bg-light wow fadeInDown"
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item @if(!isset($menu)) active @endif">
                                <a class="nav-link" href="{{route('index')}}">Home <span
                                        class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item @if(isset($menu)) @if($menu == 'service') active @endif @endif">
                            ...
                            <?php /*
                            <li class="nav-item @if(isset($menu)) @if($menu == 'product') active @endif @endif">
                                <a class="nav-link" href="{{route('products.index')}}">Product</a>
                            </li>

                            <li class="nav-item @if(isset($menu)) @if($menu == 'project') active @endif @endif">
                                <a class="nav-link" href="{{route('projects.index')}}">Project</a>
                            </li>
                            <!-- <li class="nav-item">
                                <a class="nav-link" href="#">Blog</a>
                            </li> -->
                            <li class="nav-item @if(isset($menu)) @if($menu == 'carrier') active @endif @endif">
                                <a class="nav-link" href="{{route('careers.index')}}">Career</a>
                            </li>
                            <li class="nav-item @if(isset($menu)) @if($menu == 'contactus') active @endif @endif">
