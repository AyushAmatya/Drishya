                    ...
                    <ul class="head_location wow bounceInLeft"
                        ...
                        <li><a href="#">
                                <svg class="Icon_awesome_location_arrow" viewBox="0 0 15 15">
                                    <path fill="rgba(64,64,128,1)" id="Icon_awesome_location_arrow"
                    ...
                    <ul class="head_mail wow bounceInLeft"
                        ...
                        <li>
                            <a href="#"><svg class="Icon_ionic_ios_mail_open" viewBox="3.375 2.25 13.929 15">
                                    <path fill="rgba(64,64,128,1)" id="Icon_ionic_ios_mail_open"
                ...
                <div class="col-12 col-md-8 no-pad media_respo">
                    <div class="social_media wow bounceInRight"
                         style=" visibility: visible; animation-delay: 0.4s; animation-name: bounceInRight;">
                            ...
                            <ul>
                                <li class="icon_bg1"><a href="" rel="noopener"` target="_blank" accesskey="a"><i class="fab fa-facebook-f"></i></a></li>
                                <li class="icon_bg2"><a href="" rel="noopener"` target="_blank" accesskey="b"><i class="fab fa-twitter"></i></a></li>
                                <li class="icon_bg1"><a href="" rel="noopener" target="_blank" accesskey="c"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                                </li>
                                <li class="icon_bg2"><a href="" rel="noopener" target="_blank" accesskey="d"><i class="fab fa-youtube"></i></a> </li>
                                <li class="icon_bg1"><a href="#" target="_blank" rel="noopener" ><i class="fab fa-google-plus-g" accesskey="f"></i></a></li>
                            </ul>
                    </div><!-- social_media -->
                </div><!-- col -->
            </div><!-- row -->
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-2 border_right">
                    <div class="header_opening_closing">
                        ...
                        <p>Phone Number <span> 01-4111992, 9840680875</span></p>
                    </div>
                </div><!-- col -->
                <div class="col-6 col-md-2 border_right">
                    <div class="header_opening_closing">
                ...
                <div class="col-md-3">
                    <div class="header_quote">
                        <a href="#quote" data-toggle="modal" data-target="#exampleModalCenter">Request a quote</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="{{route('services.index')}}" id="navbarDropdown">Services</a>
                                    <div class="dropdown-menu mt-0" style="background:  rgb(64, 64, 128)" aria-labelledby="navbarDropdown">
                                        
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a class="dropdown-item"  href="" style="background:rgb(64, 64, 128); margin-top : 15px; ">test</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                ...
                                {{-- <li class="nav-item @if(isset($menu)) @if($menu == 'aboutus') active @endif @endif ">
                                ...
                                <li class="nav-item dropdown" >
                                    <a class="nav-link dropdown-toggle" href="" id="navbarDropdownProduct">Product</a>
                                    <div class="dropdown-menu mt-0" style=" width:630px !important; background:  rgb(64, 64, 128)" aria-labelledby="navbarDropdown">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a class="dropdown-item"  href="" style="background:rgb(64, 64, 128); margin-top : 15px;">gbfrgb</a>
                                            </div>
                                        </div>
